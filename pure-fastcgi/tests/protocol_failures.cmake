...
function(check_cleanup scenario expected_child_exited expected_pid minimum_elapsed_ms)
  ...
  if(elapsed_ms_value LESS minimum_elapsed_ms)
    message(FATAL_ERROR "${scenario} took ${elapsed_ms_value} ms; expected at least ${minimum_elapsed_ms}")
  endif()
endfunction()
