...
foreach(required IN ITEMS SOURCE_DIR BINARY_DIR TEST_ROOT GENERATOR MAKE_PROGRAM
    CXX_COMPILER PKG_CONFIG_EXECUTABLE PURE_PKG_CONFIG_PATH PURE_EXECUTABLE)
...
function(expect_failure name expected)
  ...
  execute_process(COMMAND "${CMAKE_COMMAND}" -E env
    "PKG_CONFIG_PATH=${PURE_PKG_CONFIG_PATH}" "${CMAKE_COMMAND}"
...
expect_failure("missing Pure" "BUILD_TESTING requires an existing PURE_EXECUTABLE"
...
execute_process(COMMAND "${CMAKE_COMMAND}"
  "-DPURE_EXECUTABLE=${PURE_EXECUTABLE}" "-DPURE_SOURCE_DIR=${SOURCE_DIR}"
  "-DMODULE_DIR=${BINARY_DIR}" "-DTEST_SCRIPT=${bad_script}"
