...
if(EXPECT_DEVELOPER STREQUAL "ON")
  ...
  if(DEFINED AUTHORITATIVE_MANIFEST AND
      NOT "${AUTHORITATIVE_MANIFEST}" STREQUAL "")
    set(authoritative_manifest "${AUTHORITATIVE_MANIFEST}")
  else()
    set(authoritative_manifest
      "${build_dir}/FaustDeveloperExpected.sha256")
  endif()
  if(NOT EXISTS "${authoritative_manifest}")
    message(FATAL_ERROR "Missing authoritative FaustDeveloper manifest")
  endif()
  file(SHA256 "${developer_allowlist}" installed_manifest_sha256)
  file(SHA256 "${authoritative_manifest}" expected_manifest_sha256)
  if(NOT installed_manifest_sha256 STREQUAL expected_manifest_sha256)
    message(FATAL_ERROR
      "Installed developer manifest differs from authoritative closure")
  endif()
  file(STRINGS "${authoritative_manifest}" allowlist_lines)
