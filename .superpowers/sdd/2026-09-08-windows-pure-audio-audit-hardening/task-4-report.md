...
- Scope follows the Task 4 file list: top-level package cleanup is hardened;
  direct invocation of the four legacy subdirectory Make clean recipes remains
  outside this change. The Windows-only runner contracts are registered only
